public class homeTeam{
	...
	//run a possession: 
		...
		while(shotsSatisfied != 1) {
		    shotsSatisfied = 0; 
			if(shotType==0 && (homePlayersOnCourt[shotTakerID].getftA()/2.2)/shotAttemptDenominator > Math.random()) {shotType = 1; shotsSatisfied += 1;}
			if(shotType==0 && (homePlayersOnCourt[shotTakerID].getTwoPA())/shotAttemptDenominator > Math.random()) {shotType = 2; shotsSatisfied += 1;}
			if(shotType==0 && (homePlayersOnCourt[shotTakerID].getThreePA())/shotAttemptDenominator > Math.random()) {shotType = 3; shotsSatisfied += 1;} 
		}
